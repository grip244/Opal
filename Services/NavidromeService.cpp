    ...
    return create_async([=]() -> String^ {
        try
        {
            ...
            std::wstring rel = L"rest/getAlbumList2.view?u=" + std::wstring(_username->Data()) +
                ...
                L"&s=" + std::wstring(salt->Data()) +
                L"&v=1.16.1&c=Opal[Xbox/Windows]&f=json" +
                L"&type=" + std::wstring(Windows::Foundation::Uri::EscapeComponent(type)->Data()) +
...
String^ NavidromeService::GetCoverArtUrl(String^ id, int size)
{
    ...
    std::wstring rel = L"rest/getCoverArt.view?u=" + std::wstring(_username->Data()) +
        L"&t=" + std::wstring(token->Data()) +
        L"&s=" + std::wstring(salt->Data()) +
        L"&v=1.16.1&c=Opal[Xbox/Windows]&id=" + std::wstring(Windows::Foundation::Uri::EscapeComponent(id)->Data()) +
    ...
    return create_async([=]() -> String^ {
        try
        {
            ...
            std::wstring rel = L"rest/getLyricsBySongId.view?u=" + std::wstring(_username->Data()) +
                ...
                L"&s=" + std::wstring(salt->Data()) +
                L"&v=1.16.1&c=Opal[Xbox/Windows]&f=json" +
                L"&enhanced=true&id=" + std::wstring(Windows::Foundation::Uri::EscapeComponent(songId)->Data());
...
IAsyncOperation<String^>^ NavidromeService::GetArtistAsync(String^ id)
{
    ...
    return create_async([=]() -> String^ {
        ...
        std::wstring rel = L"rest/getArtist.view?u=" + std::wstring(_username->Data()) + L"&t=" + std::wstring(token->Data()) + L"&s=" + std::wstring(salt->Data()) + L"&v=1.16.1&c=Opal[Xbox/Windows]&f=json&id=" + std::wstring(escapedId->Data());
        std::wstring fullUrl = std::wstring(normalizedServerUrl->Data());
        if (fullUrl.back() != L'/') fullUrl += L'/';
...
IAsyncOperation<String^>^ NavidromeService::GetAlbumAsync(String^ id)
{
    ...
    return create_async([=]() -> String^ {
        ...
        auto normalizedServerUrl = NormalizeUrl(_serverUrl);
        auto escapedId = Windows::Foundation::Uri::EscapeComponent(id);
        std::wstring rel = L"rest/getAlbum.view?u=" + std::wstring(_username->Data()) + L"&t=" + std::wstring(token->Data()) + L"&s=" + std::wstring(salt->Data()) + L"&v=1.16.1&c=Opal[Xbox/Windows]&f=json&id=" + std::wstring(escapedId->Data());
        std::wstring fullUrl = std::wstring(normalizedServerUrl->Data());
        if (fullUrl.back() != L'/') fullUrl += L'/';
        return create_task(CreateRequestClient()->GetAsync(ref new Uri(ref new String((fullUrl + rel).c_str())))).then([](HttpResponseMessage^ resp) {
            return resp->IsSuccessStatusCode ? create_task(resp->Content->ReadAsStringAsync()).get() : nullptr;
...
IAsyncOperation<String^>^ NavidromeService::GetSongAsync(String^ id)
{
    ...
    return create_async([=]() -> String^ {
        ...
        auto normalizedServerUrl = NormalizeUrl(_serverUrl);
        auto escapedId = Windows::Foundation::Uri::EscapeComponent(id);
        std::wstring rel = L"rest/getSong.view?u=" + std::wstring(_username->Data()) + L"&t=" + std::wstring(token->Data()) + L"&s=" + std::wstring(salt->Data()) + L"&v=1.16.1&c=Opal[Xbox/Windows]&f=json&id=" + std::wstring(escapedId->Data());
        std::wstring fullUrl = std::wstring(normalizedServerUrl->Data());
        if (fullUrl.back() != L'/') fullUrl += L'/';
        return create_task(CreateRequestClient()->GetAsync(ref new Uri(ref new String((fullUrl + rel).c_str())))).then([](HttpResponseMessage^ resp) {
            return resp->IsSuccessStatusCode ? create_task(resp->Content->ReadAsStringAsync()).get() : nullptr;
    ...
    return create_async([=]() {
        try
        {
            ...
            std::wstring rel = L"rest/scrobble.view?u=" + std::wstring(_username->Data()) +
                ...
                L"&s=" + std::wstring(salt->Data()) +
                L"&v=1.16.1&c=Opal[Xbox/Windows]&f=json" +
                L"&id=" + std::wstring(Windows::Foundation::Uri::EscapeComponent(id)->Data()) +
...
IAsyncOperation<String^>^ NavidromeService::GetPlaylistAsync(String^ id)
{
    ...
    return create_async([=]() -> String^ {
        ...
        auto normalizedServerUrl = NormalizeUrl(_serverUrl);
        auto escapedId = Windows::Foundation::Uri::EscapeComponent(id);
        std::wstring rel = L"rest/getPlaylist.view?u=" + std::wstring(_username->Data()) + L"&t=" + std::wstring(token->Data()) + L"&s=" + std::wstring(salt->Data()) + L"&v=1.16.1&c=Opal[Xbox/Windows]&f=json&id=" + std::wstring(escapedId->Data());
        std::wstring fullUrl = std::wstring(normalizedServerUrl->Data());
        if (fullUrl.back() != L'/') fullUrl += L'/';
        return create_task(CreateRequestClient()->GetAsync(ref new Uri(ref new String((fullUrl + rel).c_str())))).then([](HttpResponseMessage^ resp) {
            return resp->IsSuccessStatusCode ? create_task(resp->Content->ReadAsStringAsync()).get() : nullptr;
...
IAsyncAction^ NavidromeService::UpdatePlaylistNameAsync(String^ playlistId, String^ newName)
{
    return create_async([this, playlistId, newName]() {
        ...
        auto normalizedServerUrl = NormalizeUrl(_serverUrl);
        auto escapedPid = Windows::Foundation::Uri::EscapeComponent(playlistId);
        auto escapedName = Windows::Foundation::Uri::EscapeComponent(newName);
        std::wstring rel = L"rest/updatePlaylist.view?u=" + std::wstring(_username->Data()) + L"&t=" + std::wstring(token->Data()) + L"&s=" + std::wstring(salt->Data()) + L"&v=1.16.1&c=Opal[Xbox/Windows]&f=json&playlistId=" + std::wstring(escapedPid->Data()) + L"&name=" + std::wstring(escapedName->Data());
        std::wstring fullUrl = std::wstring(normalizedServerUrl->Data());
        if (fullUrl.back() != L'/') fullUrl.append(L"/");
        create_task(CreateRequestClient()->GetAsync(ref new Uri(ref new String((fullUrl + rel).c_str())))).get();
    });
}
